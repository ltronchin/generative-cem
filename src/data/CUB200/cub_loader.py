...
def find_class_imbalance(pkl_file, multiple_attr=False, attr_idx=-1):
    ...
    """
    imbalance_ratio = []
    base_dir = os.path.join(DATASET_DIR, '../../../data/CUB_200_2011/interim/class_attr_data_10')
...
def generate_data(
    ...
    if root_dir is None:
        root_dir = DATASET_DIR
    base_dir = os.path.join(root_dir, '../../../data/CUB_200_2011/interim/class_attr_data_10')
